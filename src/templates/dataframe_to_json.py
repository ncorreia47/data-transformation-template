import json
import pandas as pd
from template.strategy_methods import DataFrameToFileTemplate
from enums import FileMode, FileEncoding

# TO-DO: Refatorar código para implementação de strategy method

class DataFrameToJsonFile(DataFrameToFileTemplate):
    """
